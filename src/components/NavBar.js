        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#projects" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Réalisations</Nav.Link>
            </Nav>
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://github.com/mawed22/"><img src={navIcon3} alt="" /></a>
                <a href="https://www.linkedin.com/in/mohamed-foupoua/"><img src={navIcon1} alt="" /></a>
                <a href="https://web.facebook.com/FMoahmed2/"><img src={navIcon2} alt="" /></a>
              </div>
              <HashLink to='#connect'>
